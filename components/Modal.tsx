...
const Modal: React.FC<ModalProps> = ({isOpen, onClose, onSubmit, title, body, footer, actionLabel, disabled}) => {
    ...
    return (
        <>
            <div
                className="flex items-center justify-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-70">
                    ...
                    <div
                        ...
                        <div className="flex flex-col gap-2 p-10">
                            <Button
                                ...
                                label={actionLabel}
                                secondary
                                large fullWidth onClick={handleSubmit}
                            />
                            {footer}
                        </div>
                    </div>
